...
namespace NMib::NCloud::NAppManager
{
	void CAppManagerActor::fp_BuildCommandLine(CDistributedAppCommandLineSpecification &o_CommandLine)
	{
			...
			(
				{
					...
					{
						"Names"_o= _o["--log-launches-to-stderr"]
						,"Default"_o= false
			...
			(
				{
					...
					{
						"Names"_o= _o["--host-monitor-interval"]
						,"Type"_o= 0.0
			...
			(
				{
					...
					{
						"Names"_o= _o["--host-monitor-patch-interval"]
						,"Type"_o= 0.0
			...
			(
				{
					...
					{
						"Names"_o= _o["--host-monitor-memory-interval"]
						,"Type"_o= 0.0
			...
			(
				{
					...
					{
						"Names"_o= _o["--application-status-sensors"]
						,"Default"_o= true
			...
			(
				{
					...
					{
						"Names"_o= _o["--encryption-status-sensors"]
						,"Default"_o= true
		...
		auto SettingsOption_RunAsUserPassword = "RunAsUserPassword?"_o=
			{
				"Names"_o= _o["--run-as-user-password"]
				, "Type"_o= ""
		...
		auto SettingsOption_RunAsUserHasShell = "RunAsUserHasShell?"_o=
			{
				"Names"_o= _o["--run-as-user-has-shell"]
				, "Type"_o= ""
		...
		auto SettingsOption_StopOnDependencyFailure = "StopOnDependencyFailure?"_o=
			{
				"Names"_o= _o["--stop-on-dependency-failure"]
				, "Type"_o= true
		...
		auto SettingsOption_BackupIncludeWildcards = "BackupIncludeWildcards?"_o=
			{
				"Names"_o= _o["--backup-include-wildcards"]
				, "Type"_o=
				{
					"*"_o= COneOfType{"", COneOf{nullptr}}
				}
		...
		auto SettingsOption_BackupExcludeWildcards = "BackupExcludeWildcards?"_o=
			{
				"Names"_o= _o["--backup-exclude-wildcards"]
				, "Type"_o= _o[""]
		...
		auto SettingsOption_BackupAddSyncFlagsWildcards = "BackupAddSyncFlagsWildcards?"_o=
			{
				"Names"_o= _o["--backup-add-sync-flags-wildcards"]
				, "Type"_o=
				{
					"*"_o= _o[""]
				}
		...
		auto SettingsOption_BackupRemoveSyncFlagsWildcards = "BackupRemoveSyncFlagsWildcards?"_o=
			{
				"Names"_o= _o["--backup-remove-sync-flags-wildcards"]
				, "Type"_o=
				{
					"*"_o= _o[""]
				}
		...
		auto AddOption_UpdateScriptPostUpdate = "UpdateScript_PostUpdate?"_o=
			{
				"Names"_o= _o["--update-script-post-update"]
				, "Default"_o= ""
		...
		auto AddOption_UpdateScriptPostLaunch = "UpdateScript_PostLaunch?"_o=
			{
				"Names"_o= _o["--update-script-post-launch"]
				, "Default"_o= ""
		...
		auto AddOption_UpdateScriptOnError = "UpdateScript_OnError?"_o=
			{
				"Names"_o= _o["--update-script-on-error"]
				, "Default"_o= ""
			...
			(
				{
					...
					, "Options"_o=
					{
						...
						, "ExecutableParameters?"_o=
						{
							...
							, "Default"_o= _o["--daemon-run-standalone"]
							, "Type"_o= _o[""]
						...
						, "SelfUpdateSource?"_o=
						{
							"Names"_o= _o["--self-update-source"]
							, "Default"_o= false
		...
		ApplicationManagement.f_RegisterCommand
			(
				{
					"Names"_o= _o["--application-enable-self-update"]
					, "Description"_o=
		...
		ApplicationManagement.f_RegisterCommand
			(
				{
					"Names"_o= _o["--application-change-settings"]
		...
		ApplicationManagement.f_RegisterCommand
			(
				{
					"Names"_o= _o["--application-remove"]
		...
		ApplicationManagement.f_RegisterCommand
			(
				{
					"Names"_o= _o["--application-update-from-file"]
		...
		ApplicationManagement.f_RegisterCommand
			(
				{
					"Names"_o= _o["--application-update"]
		...
		ApplicationManagement.f_RegisterCommand
			(
				{
					"Names"_o= _o["--application-restart"]
		...
		ApplicationManagement.f_RegisterCommand
			(
				{
					"Names"_o= _o["--cancel-all-updates"]
		...
		ExternalManagement.f_RegisterCommand
			(
				{
					"Names"_o= _o["--version-manager-list"]
		...
		ExternalManagement.f_RegisterCommand
			(
				{
					"Names"_o= _o["--cloud-manager-list"]
		...
		ExternalManagement.f_RegisterCommand
			(
				{
					"Names"_o= _o["--stored-update-notifications-list"]
		...
		ExternalManagement.f_RegisterCommand
			(
				{
					"Names"_o= _o["--stored-update-notifications-clear"]
