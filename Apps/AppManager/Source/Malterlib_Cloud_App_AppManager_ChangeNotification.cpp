...
namespace NMib::NCloud::NAppManager
{
	...
	{
		// Wait 10 seconds for notifications to be delivered to all
		co_await fp_SendAppChange_Empty(_ApplicationName).f_Timeout(10.0, "Timed out syncing notifications").f_Wrap() > fg_LogError("ChangeNotifications", "Error syncing notifications");
		co_return {};
	}
