...
namespace
{
	void fg_RegisterVirtualMachineWindowAction()
	{
		...
		NConcurrency::fg_RegisterCommandLineClientAction
			(
				"VirtualMachineWindow"
				, [](NEncoding::CEJsonSorted _Params, NStorage::TCSharedPointer<NConcurrency::CRunLoop> _pRunLoop) -> NConcurrency::TCFuture<NEncoding::CEJsonSorted>
				{
