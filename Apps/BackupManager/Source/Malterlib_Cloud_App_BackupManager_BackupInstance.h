...
namespace NMib::NCloud::NBackupManager
{
	...
	public:
		...
		TCFuture<void> f_ManifestChange(NStr::CStr _FileName, CManifestChange _Change) override;
		TCFuture<void> f_AppendData(CStr _FileName, CAppendData _Data) override;
