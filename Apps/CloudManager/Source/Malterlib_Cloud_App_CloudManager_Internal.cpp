...
{
	constexpr CStr const CCloudManagerServer::mcp_DatabasePrefixLog = gc_Str<"mib.llog">; // llog = local log
	constexpr CStr const CCloudManagerServer::mcp_DatabasePrefixSensor = gc_Str<"mib.lsensor">; // lsensor = local sensor
